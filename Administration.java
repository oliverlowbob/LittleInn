...

{
   ...
   public boolean cancelReservation() 
   {
      ...
      if (valg ==1)
      {  System.out.println("Hvilken reservation vil du slette?");
         int index = scanner.nextInt();
         myReservations[index] = null;
         System.gc();
         System.out.println("Hvilket værelse havde reservationen?");
         int room = scanner.nextInt();
         myRooms[room].setIsBooked(false);
